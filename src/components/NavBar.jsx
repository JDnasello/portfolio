...
import CV from "/src/img/CV-Juan-Diego-Nasello.pdf";
  ...
  return (
    <header className="container-navbar">
      <div>
        ...
        >
          &lt;<span className="navbar-name">JDNasello</span> &#47;&gt;
        </span>
        ...
        <nav className={menuClass}>
          <a href="#experience" className="menu-a">
            {t("header.experience-link")}
          </a>
          ...
          <a download href={CV} className="download-cv">
            <LiaDownloadSolid /> CV
          </a>
        </nav>
      </div>
